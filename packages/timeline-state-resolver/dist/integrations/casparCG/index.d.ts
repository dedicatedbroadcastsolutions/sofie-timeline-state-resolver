...
import { DeviceType, CasparCGOptions, DeviceOptionsCasparCG, Mappings, Timeline, TSRTimelineContent, CasparCGActionExecutionResult, CasparCGActions, CasparCGActionExecutionPayload } from 'timeline-state-resolver-types';
...
export declare class CasparCGDevice extends DeviceWithState<State, DeviceOptionsCasparCGInternal> {
    ...
    executeAction<A extends CasparCGActions>(actionId: A, payload: CasparCGActionExecutionPayload<A>): Promise<CasparCGActionExecutionResult<A>>;
    /**
